...
export const cardStyles = {
  ...
  doctorCard: "bg-white border border-med-soft rounded-2xl p-6 shadow-md hover:shadow-med-vibrant transform hover:-translate-y-2 transition-all duration-300 flex flex-col items-center",
  serviceCard: "bg-white border border-med-soft rounded-2xl p-6 shadow-md",
  
  // Image containers
  doctorImageContainer: "w-28 h-28 rounded-full border-4 border-med-soft shadow-md bg-med-lightest flex items-center justify-center overflow-hidden",
  serviceImageContainer: "w-28 h-28 rounded-full border-4 border-med-soft mx-auto bg-med-lightest flex items-center justify-center overflow-hidden",
  ...
  dateContainer: "mt-4 rounded-full border bg-med-lightest border-med-soft py-1 px-3 w-full flex justify-center gap-2",
  serviceDateContainer: "mt-4 rounded-full border bg-med-lightest border-med-soft py-1 px-3 flex justify-center gap-2 text-sm",
  timeContainer: "mt-2 rounded-full border bg-med-lightest border-med-soft py-1 px-3 w-full flex justify-center gap-2",
  serviceTimeContainer: "mt-2 rounded-full border bg-med-lightest border-med-soft py-1 px-3 flex justify-center gap-2 text-sm",
...
export const bannerStyles = {
  ...
  outerAnimatedBand: "absolute inset-0 rounded-3xl bg-linear-to-r from-med-vibrant via-med-vibrant to-med-vibrant animate-[spin_3s_linear_infinite] opacity-80",
  ...
  stethoscopeInner: "relative bg-linear-to-br from-med-soft to-med-vibrant p-3 rounded-full shadow-lg transform -rotate-6 hover:rotate-0 transition-transform duration-300",
  ...
  titleGradient: "text-transparent bg-linear-to-r from-med-vibrant to-med-vibrant bg-clip-text",
  ...
  featureItem: "flex items-center justify-center lg:justify-start bg-linear-to-br from-med-vibrant to-med-soft backdrop-blur-sm p-3 rounded-full shadow-sm border",
  ...
  bookButton: "group relative lg:whitespace-nowrap bg-linear-to-r from-med-vibrant to-med-soft text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold transform transition-all duration-300 shadow-2xl hover:shadow-3xl overflow-hidden text-sm sm:text-base",
...
export const loginPageStyles = {
  // Main container
  mainContainer: "min-h-screen flex items-center justify-center bg-linear-to-br from-med-lightest via-med-light to-med-soft relative font-serif overflow-hidden",
  ...
  // Login card
  loginCard: "relative z-10 bg-white/60 backdrop-blur-xl shadow-2xl rounded-3xl p-8 w-[90%] max-w-md border border-med-soft transition-all duration-500 hover:shadow-med-soft/50",
  ...
  // Input fields
  input: "w-full px-5 py-3 rounded-full border border-med-soft bg-white/80",
  
  // Submit button
  submitButton: "w-full py-3 bg-linear-to-r from-med-vibrant to-med-vibrant text-white font-semibold rounded-full",
...
export const navbarStyles = {
  // Main container
  navbarContainer: "sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-med-light transition-transform duration-500",
  ...
  logoContainer: "relative group w-12 h-12 sm:w-14 sm:h-14 lg:w-12 lg:h-12 xl:w-14 xl:h-14",
  logoImageWrapper: "relative flex items-center justify-center overflow-hidden p-1.5 h-full w-full",
  logoImage: "w-10 h-10 sm:w-12 sm:h-12 lg:w-10 lg:h-10 xl:w-12 xl:h-12 object-contain",
  logoTextContainer: "block",
  logoTitle: "text-lg sm:text-xl lg:text-lg xl:text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-med-vibrant to-med-vibrant tracking-tight",
  logoSubtitle: "text-[9px] sm:text-[10px] lg:text-[9px] xl:text-[10px] text-gray-500",
  
  // Desktop navigation
  desktopNav: "hidden xl:flex items-center gap-2 flex-shrink-0",
  navItemsContainer: "flex gap-0.5 bg-white border border-med-soft p-0.5 rounded-full shadow-lg",
  ...
  navItemInactive: "text-gray-700 hover:text-med-vibrant",
  ...
  loginButton: "btn-login hidden xl:flex text-xs xl:text-sm items-center gap-2 bg-linear-to-r from-med-vibrant to-med-vibrant text-white px-5 py-2 rounded-full font-semibold hover:shadow-xl transition-all duration-300 cursor-default",
  loginIcon: "w-3.5 h-3.5",
  
  // Mobile toggle
  mobileToggle: "xl:hidden p-2.5 rounded-lg hover:bg-med-lightest transition-colors",
  toggleIcon: "w-6 h-6 text-gray-900",
  
  // Mobile menu
  mobileMenu: "mobile-menu xl:hidden pb-4 space-y-2 border-t border-med-light pt-4",
  mobileMenuItem: "block px-4 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300",
  mobileMenuItemActive: "bg-med-vibrant text-white",
  mobileMenuItemInactive: "text-gray-700 hover:bg-med-lightest hover:text-med-vibrant",
  
  // Mobile signed out buttons
  mobileDoctorAdminButton: "w-full flex items-center justify-center gap-2 py-2.5 rounded-full border border-med-soft bg-white text-sm font-semibold hover:bg-med-lightest transition-all",
  mobileLoginContainer: "w-full mt-3",
  mobileLoginButton: "w-full cursor-default md:rounded-full flex items-center justify-center gap-2 bg-linear-to-r from-med-vibrant to-med-vibrant text-white py-2.5 rounded-lg font-semibold hover:shadow-lg transition-all",
...
export const serviceCardStyles = {
  // Card container
  card: "group rounded-2xl overflow-hidden bg-white shadow-xl hover:-translate-y-2 transition-transform duration-500 border border-med-light",
  ...
  buttonAvailable: "inline-flex items-center justify-center gap-2 px-5 py-2 w-full rounded-full bg-med-vibrant text-white font-medium",
...
export const navbarStylesDr = {
  // Main navbar
  navContainer: "fixed top-8 left-1/2 -translate-x-1/2 z-50 w-full md:max-w-2xl lg:max-w-4xl pl-4 pr-8 py-0 rounded-full bg-white/80 backdrop-blur-md border border-med-light shadow-2xl flex items-center justify-between gap-3 font-serif transition-all duration-300 hover:shadow-med-soft/80 hover:-translate-y-0.5",
  ...
  brandTitle: "text-3xl text-med-dark font-semibold tracking-wide",
  brandSubtitle: "text-xs text-med-vibrant",
  ...
  activeLink: "bg-med-vibrant text-white shadow-lg scale-105 ring-2 ring-med-soft",
  inactiveLink: "text-med-dark hover:bg-med-lightest hover:text-med-dark hover:-translate-y-0.5 hover:shadow",
  ...
  logoutButtonDesktop: "hidden lg:flex items-center gap-2 px-4 py-2 rounded-full bg-white text-med-dark border border-med-soft shadow-sm text-sm font-semibold transition-all duration-200 transform hover:scale-105 hover:-translate-y-0.5",
  
  // Hamburger menu buttons
  hamburgerButtonMd: "md:hidden p-2 rounded-md hover:bg-med-lightest transition-colors",
  hamburgerButtonLg: "hidden md:flex lg:hidden p-2 rounded-md hover:bg-med-lightest transition-colors",
  
  // Mobile/tablet menu
  mobileMenuContainer: (isOpen) => 
    `lg:hidden fixed top-30 left-1/2 -translate-x-1/2 z-40 w-[92%] max-w-md bg-white/95 backdrop-blur-md border border-med-light rounded-2xl shadow-lg transform origin-top transition-all duration-200 ${isOpen ? "scale-100 opacity-100 translate-y-0" : "scale-95 opacity-0 -translate-y-2 pointer-events-none"}`,
  ...
  mobileActiveLink: "bg-med-lightest text-med-dark",
  mobileInactiveLink: "text-med-dark hover:bg-med-lightest",
  
  // Mobile logout button
  mobileLogoutButton: "mt-2 px-4 py-2 rounded-full text-center bg-med-vibrant text-white font-semibold text-sm shadow-sm transition-transform duration-150 hover:scale-105 w-full",
...
export const listPageStyles = {
  // Main container
  pageContainer: "min-h-screen pt-20 md:pt-25 lg:pt-25 font-serif p-4 sm:p-6 bg-linear-to-br from-med-lightest to-white",
  ...
  headerTitle: "text-xl sm:text-xl pt-5 md:pt-0 lg:pt-0 xl:pt-0 font-extrabold text-med-dark",
  headerSubtitle: "text-xs sm:text-sm text-med-dark",
  ...
  searchIconContainer: "absolute inset-y-0 left-3 flex items-center pointer-events-none text-med-vibrant",
  searchIcon: "w-4 h-4",
  searchInput: "pl-10 pr-10 w-full sm:w-64 md:w-80 lg:w-96 py-2 rounded-full border border-med-soft bg-white text-med-dark focus:ring-2 focus:ring-med-soft outline-none",
  clearSearchButton: "absolute right-2 top-1/2 -translate-y-1/2 text-med-vibrant hover:text-med-dark p-1 rounded-full",
  clearSearchIcon: "w-4 h-4",
  statusFilter: "text-sm px-3 py-2 rounded-full border border-med-soft bg-white w-full sm:w-auto",
  
  // Loading and error states
  loadingContainer: "text-center py-8 text-med-vibrant",
  ...
  // Appointment card
  appointmentCard: "rounded-2xl p-4 bg-white shadow-sm border border-med-light hover:shadow-md transition flex flex-col justify-between self-start",
  
  // Card header
  cardHeader: "flex flex-col sm:flex-row items-start sm:items-center gap-3",
  cardAvatar: "w-12 h-12 sm:w-14 sm:h-14 rounded-full overflow-hidden bg-med-lightest border border-med-light flex items-center justify-center",
  cardAvatarImage: "w-full h-full object-cover",
  cardAvatarFallback: "text-med-dark font-bold",
  cardContent: "flex-1 min-w-0",
  cardPatientName: "text-sm md:text-lg font-bold text-med-dark truncate",
  cardPatientInfo: "text-xs md:text-sm text-med-dark mt-1",
  cardDoctorInfo: "mt-2 text-sm text-med-dark truncate",
  cardDoctorName: "font-semibold text-med-dark",
  cardSpeciality: "text-sm text-med-dark font-medium truncate",
  
  // Date and time section
  dateTimeSection: "mt-4 flex flex-col items-start gap-3",
  dateTimeContainer: "text-md md:text-lg text-med-dark font-bold flex items-center gap-2 w-full",
  calendarIcon: "w-4 h-4",
  dateText: "whitespace-nowrap truncate",
  feeText: "text-sm text-med-dark font-semibold",
  
  // Contact and status section
  contactStatusSection: "mt-4 flex flex-col items-start gap-3",
  phoneContainer: "text-sm text-med-dark flex items-center gap-2",
  phoneIcon: "w-4 h-4",
  ...
  statusBadgeComplete: "bg-med-light text-med-dark border border-med-soft",
  statusBadgeCancelled: "bg-rose-100 text-rose-800 border border-rose-200",
  statusBadgeConfirmed: "bg-med-soft text-med-dark border border-med-soft",
  ...
  statusSelectEnabled: "bg-white text-med-dark border-med-soft hover:shadow-sm",
  ...
  rescheduleButtonEnabled: "bg-white text-med-dark border-med-soft hover:shadow-sm",
  ...
  dateInput: "text-sm px-3 py-2 rounded-full border border-med-soft bg-white w-full md:w-40",
  timeInput: "text-sm px-3 py-2 rounded-full border border-med-soft bg-white w-full md:w-36",
  rescheduleButtons: "flex gap-2",
  saveButton: "text-sm px-3 py-2 rounded-full bg-med-vibrant text-white font-semibold hover:bg-med-dark transition",
  cancelButton: "text-sm px-3 py-2 rounded-full border border-med-soft bg-white text-med-dark hover:shadow-sm transition"
};
...
export const editProfilePageStyles = {
  // Page container
  pageContainer: "min-h-screen font-serif bg-linear-to-br from-med-lightest via-white to-med-lightest/30 p-4 sm:p-5 md:p-6",
  ...
  toastSuccess: "bg-linear-to-r from-med-lightest to-med-light border-l-4 border-med-vibrant",
  toastError: "bg-linear-to-r from-rose-50 to-rose-100 border-l-4 border-rose-500",
  toastInfo: "bg-linear-to-r from-med-lightest to-med-light border-l-4 border-med-vibrant",
  toastIcon: "w-5 h-5 mt-0.5",
  toastSuccessIcon: "text-med-vibrant",
  toastErrorIcon: "text-rose-600",
  toastText: "text-sm font-medium text-gray-800",
  
  // Main card
  mainCard: "bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-med-light/50",
  headerBackground: "relative h-24 sm:h-28 md:h-32 bg-linear-to-r from-med-vibrant to-med-vibrant",
  ...
  imageEditIcon: (editing) => `w-5 h-5 ${editing ? "text-med-vibrant" : "text-gray-400"}`,
  imageInput: "hidden",
  ...
  profileName: "text-2xl sm:text-3xl md:text-4xl font-bold bg-linear-to-r from-med-dark to-med-dark bg-clip-text text-transparent truncate",
  profileSubtitle: "text-sm sm:text-lg text-med-dark mt-2 flex items-center gap-2",
  subtitleIcon: "w-4 h-4",
  
  // Stats container
  statsContainer: "mt-4 flex flex-wrap items-center gap-3",
  statItem: "flex items-center gap-3 bg-white px-3 py-2 rounded-full border border-med-light shadow-sm text-sm sm:text-base",
  ...
  availabilityToggle: (isAvailable) => `flex items-center gap-3 px-4 sm:px-5 py-2 rounded-full cursor-pointer border-2 shadow-sm transition-all duration-300 ${isAvailable ? "bg-linear-to-r from-med-lightest to-med-light border-med-soft hover:shadow-med-soft" : "bg-linear-to-r from-gray-50 to-gray-100 border-gray-300 hover:shadow-gray-200"} hover:shadow-lg w-full sm:w-auto`,
  toggleTrack: (isAvailable) => `relative w-10 h-5 rounded-full transition-colors ${isAvailable ? "bg-med-vibrant" : "bg-gray-400"}`,
  toggleThumb: (isAvailable) => `absolute top-0.5 w-4 h-4 rounded-full bg-white transition-transform ${isAvailable ? "left-6" : "left-0.5"}`,
  toggleText: (isAvailable) => `font-medium ${isAvailable ? "text-med-dark" : "text-gray-600"}`,
  
  editButton: "group relative overflow-hidden bg-linear-to-r from-med-vibrant to-med-dark hover:from-med-dark hover:to-med-dark text-white px-5 py-2 rounded-full cursor-pointer shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] w-full sm:w-auto",
  editButtonContent: "relative flex items-center gap-2",
  
  // Form sections
  formSection: "mb-8",
  sectionTitle: "text-xl sm:text-2xl font-bold text-med-dark mb-6 flex items-center gap-2",
  sectionIconContainer: "w-8 h-8 rounded-full bg-med-light flex items-center justify-center",
  sectionIcon: "w-4 h-4 text-med-vibrant",
  
  // Field grid
  fieldGrid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6",
  fieldGroup: "group",
  fieldHeader: "flex items-center gap-3 mb-2",
  fieldIconContainer: (editing) => `p-2 rounded-full ${editing ? "bg-med-light text-med-vibrant" : "bg-gray-100 text-gray-500"}`,
  fieldIcon: "w-4 h-4",
  fieldLabel: "text-sm font-semibold text-med-dark",
  
  // Input fields
  inputBase: (editing) => `w-full rounded-full border-2 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base transition-all duration-200 ${editing ? "border-med-soft bg-med-lightest/50 focus:border-med-vibrant focus:ring-2 focus:ring-med-soft focus:bg-white" : "border-gray-200 bg-gray-50/50 text-gray-600 cursor-not-allowed"}`,
  
  // About textarea
  aboutTextarea: (editing) => `w-full rounded-xl border-2 px-4 py-3 text-sm sm:text-base transition-all duration-200 ${editing ? "border-med-soft bg-med-lightest/50 focus:border-med-vibrant focus:ring-2 focus:ring-med-soft focus:bg-white" : "border-gray-200 bg-gray-50/50 text-gray-600 cursor-not-allowed"}`,
  ...
  emptySchedule: "text-center py-10 rounded-2xl border-2 border-dashed border-med-soft bg-med-lightest/50",
  emptyScheduleIcon: "w-12 h-12 text-med-vibrant mx-auto mb-3",
  emptyScheduleText: "text-med-dark font-medium",
  emptyScheduleSubtext: "text-sm text-med-vibrant mt-1",
  
  // Schedule grid
  scheduleGrid: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5",
  
  // Date card
  dateCard: "group relative bg-linear-to-br from-white to-med-lightest p-4 sm:p-5 rounded-2xl border border-med-light shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1",
  dateHeader: "flex items-center justify-between mb-3 pb-3 border-b border-med-light",
  dateIconContainer: "p-2 rounded-full bg-med-light",
  dateIcon: "w-5 h-5 text-med-vibrant",
  dateTitle: "font-bold text-base sm:text-lg text-med-dark",
  dateSubtitle: "text-xs sm:text-sm text-med-vibrant",
  dateSlotCount: "text-xs font-medium px-3 py-1 rounded-full bg-med-light text-med-dark",
  ...
  timeSlotItem: "flex items-center justify-between bg-white px-3 py-2 rounded-full border border-med-light hover:border-med-soft transition-colors",
  timeSlotIcon: "w-4 h-4 text-med-vibrant",
  timeSlotText: "font-medium text-med-dark text-sm sm:text-base",
  ...
  // Add time slot
  addSlotContainer: "pt-3 border-t border-med-light",
  addSlotInput: "flex-1 rounded-full px-3 py-2 text-sm border border-med-soft bg-white focus:outline-none focus:ring-2 focus:ring-med-soft",
  addSlotButton: "p-2 rounded-full cursor-pointer bg-med-light text-med-dark hover:bg-med-soft transition-colors",
  addSlotIcon: "w-4 h-4",
  
  // Save message
  saveMessage: (type) => `px-4 py-2 rounded-lg ${type === "saving" ? "bg-med-lightest text-med-dark border border-med-soft" : "bg-med-lightest text-med-dark border border-med-soft"}`,
  
  // Actions section
  actionsSection: "flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-med-light",
  actionsText: "text-sm text-gray-500",
  actionsButtons: "flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto",
  resetButton: "px-6 py-3 rounded-full cursor-pointer border-2 border-med-soft text-med-dark hover:bg-med-lightest hover:border-med-soft transition-all duration-200 font-medium w-full sm:w-auto text-center",
  saveButton: "group relative overflow-hidden bg-linear-to-r from-med-vibrant to-med-dark hover:from-med-dark hover:to-med-dark text-white px-6 py-3 rounded-full cursor-pointer shadow-lg transition-all duration-300 hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed w-full sm:w-auto text-center",
  ...
  addDateInput: "rounded-xl px-3 py-2 border-2 border-med-soft bg-white focus:outline-none focus:ring-2 focus:ring-med-soft focus:border-med-vibrant text-sm sm:text-base",
  addDateButton: "flex items-center gap-2 bg-linear-to-r from-med-vibrant to-med-vibrant hover:from-med-vibrant hover:to-med-dark text-white px-4 py-2 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 text-sm sm:text-base",
  addDateIcon: "w-4 h-4",
...
export const dashboardStyles = {
  // Main container
  pageContainer: "min-h-screen font-serif pt-16 lg:pt-20 md:pt-15 p-4 sm:p-6 bg-linear-to-br from-med-lightest to-white",
  ...
  // Header section
  headerContainer: "mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4",
  headerTitle: "text-2xl pt-10 xl:pt-0 uppercase lg:pt-0 sm:text-3xl font-extrabold tracking-tight text-med-dark",
  headerSubtitle: "text-sm sm:text-base text-med-dark/70",
  headerInfo: "text-sm text-slate-600",
  refreshButton: "text-sm px-3 py-1 rounded-full bg-white text-med-vibrant border border-med-soft hover:shadow-sm",
  
  // Stats grid
  statsGrid: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8",
  
  // Stat card
  statCard: "rounded-full p-4 bg-white/60 backdrop-blur-sm border border-med-soft shadow-sm hover:shadow-md transition-all",
  statContent: "flex items-center justify-between gap-4",
  statTextContainer: "flex-1",
  statTitle: "text-sm font-medium text-med-dark/80",
  statValue: "mt-2 text-xl sm:text-2xl font-extrabold text-med-dark tracking-tight",
  statIconContainer: "p-3 rounded-full bg-linear-to-br border shadow-md",
  statIcon: "w-6 h-6 text-med-dark",
  
  // Stat card accent colors
  accentTopEmerald: "from-med-soft to-med-soft",
  accentTopAmber: "from-amber-100 to-amber-200",
  accentTopEmeraldLight: "from-med-light to-med-soft",
  accentTopRose: "from-rose-100 to-rose-200",
  accentBottomEmerald: "border-med-soft",
  accentBottomAmber: "border-amber-200",
  accentBottomRose: "border-rose-200",
  
  // Appointments container
  appointmentsContainer: "bg-white/60 backdrop-blur-sm rounded-2xl p-4 border border-med-light shadow-sm",
  appointmentsHeader: "flex items-center justify-between mb-4",
  appointmentsTitle: "text-lg sm:text-xl font-semibold text-med-dark",
  appointmentsTotal: "text-sm sm:text-base text-med-dark flex items-center gap-2",
  totalIcon: "w-4 h-4",
  ...
  // Appointment card
  appointmentCard: "rounded-xl p-4 bg-white shadow-sm border border-med-light flex flex-col justify-between gap-4 hover:shadow-md transition self-start",
  cardHeader: "flex items-start gap-3",
  cardAvatar: "w-12 h-12 sm:w-14 sm:h-14 rounded-full overflow-hidden bg-med-lightest border border-med-light flex items-center justify-center",
  cardAvatarImage: "w-full h-full object-cover",
  cardAvatarFallback: "text-med-dark font-bold",
  cardContent: "flex-1",
  cardPatientName: "text-base sm:text-lg font-bold text-med-dark",
  cardPatientInfo: "text-xs sm:text-sm text-med-dark mt-1",
  cardDoctorInfo: "mt-2 text-sm sm:text-sm text-med-dark",
  cardDoctorName: "font-semibold text-med-dark",
  cardSpeciality: "text-xs sm:text-sm text-med-dark font-medium",
  cardPhoneContainer: "mt-2 text-xs sm:text-sm text-med-vibrant flex items-center gap-2",
  cardPhoneIcon: "w-4 h-4",
  
  // Date and time section
  dateTimeContainer: "flex items-center justify-between",
  dateText: "text-sm sm:text-lg font-bold text-med-dark",
  timeText: "text-sm sm:text-base font-semibold text-med-dark",
  
  // Card footer
  cardFooter: "flex flex-col items-end gap-2",
  feeText: "text-sm sm:text-base text-med-dark font-medium",
  statusContainer: "flex items-center gap-2",
  
  // Show more button
  showMoreContainer: "mt-4 flex justify-center",
  showMoreButton: "px-4 py-2 rounded-full bg-med-vibrant text-white text-sm font-semibold hover:bg-med-dark transition",
  ...
  rescheduleDateInput: "text-xs px-3 py-2 rounded-full border border-med-soft bg-white w-full md:w-48 lg:w-56",
  rescheduleTimeInput: "text-xs px-3 py-2 rounded-full border border-med-soft bg-white w-full md:w-48 lg:w-56",
  rescheduleButtons: "flex gap-2",
  saveButton: "text-xs px-3 py-2 rounded-full bg-med-vibrant text-white font-semibold hover:bg-med-dark transition",
  cancelButton: "text-xs px-3 py-2 rounded-full border border-med-soft bg-white text-med-dark hover:shadow-sm transition"
};