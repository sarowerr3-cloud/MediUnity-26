                ...
                return (
                  <React.Fragment key={post._id}>
                    ...
                    <div className="flex items-center gap-2 text-xs text-slate-400 mt-2 mb-4">
                      ...
                      <span>Asked by <span className="font-semibold text-slate-600 inline-flex items-center gap-1">{post.authorName} {post.authorRole === "doctor" && <VerifiedBadge isVerified={post.doctorIsVerified} hideUnverified={true} size="sm" />}</span></span>
                    </div>
