              ...
              return (
                <div key={post._id} className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="flex items-center gap-2 text-xs text-slate-500 mt-2 mb-4">
                    ...
                    <span>Asked by <span className="font-semibold text-slate-700 inline-flex items-center gap-1">{post.authorName} {post.authorRole === "doctor" && <VerifiedBadge isVerified={post.doctorIsVerified} hideUnverified={true} size="sm" />}</span></span>
                  </div>
