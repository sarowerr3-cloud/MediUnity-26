          ...
          {loading ? (
            ...
            <div className="text-center py-10">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 font-bold text-sm transition disabled:opacity-50"
              >
                <BellRing className="w-4 h-4" />
                {requestSent ? "Request is sent" : requesting ? "Sending Request..." : "Request Patient to Update Profile"}
              </button>
            </div>
          ) : (
