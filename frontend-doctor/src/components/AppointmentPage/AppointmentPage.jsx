...
export default function AppointmentPage() {
  ...
  const renderDoctorAppointmentCard = (item) => (
    <div key={item.id} className={cardStyles.doctorCard}>
      ...
      {item.serialNumber && (
        <div className="mt-1 px-3 py-1 bg-slate-50 border border-slate-200 rounded-xl text-[10px] font-mono text-slate-500 font-bold select-all w-max">
        ...
        {item.queueState === "CheckedIn" && (
          <div className="w-full space-y-2">
            ...
            {(() => {
              ...
              return (
                <div className="p-3 bg-amber-50/50 border border-amber-200 rounded-2xl space-y-2.5 text-left font-sans">
                  ...
                  <div className="grid grid-cols-2 gap-2 divide-x divide-amber-200">
                    <div>
                      <p className="text-[8px] text-slate-400 font-bold uppercase tracking-wider">Queue Position</p>
                      <p className="text-[11px] font-bold text-slate-700 mt-0.5">
                        {patientsAhead > 0 ? `${patientsAhead} patient${patientsAhead > 1 ? 's' : ''} ahead` : "Next in line!"}
                      </p>
                    </div>
                    <div className="pl-3">
                      <p className="text-[8px] text-slate-400 font-bold uppercase tracking-wider">Estimated Wait</p>
                      <p className="text-[11px] font-bold text-slate-700 mt-0.5">
                        ~{estWaitMinutes} mins
                      </p>
                    </div>
                  ...
                  <div className="pt-1 flex items-center justify-between text-[8px] font-bold text-slate-400">
                    ...
                    <div className="flex-grow border-t border-dashed border-emerald-400 mx-1.5 h-0" />
                    <div className="flex flex-col items-center gap-0.5">
                      <span className="w-3.5 h-3.5 rounded-full bg-amber-500 text-white flex items-center justify-center text-[7px]">✓</span>
                      <span className="text-amber-700">Checked In</span>
                    </div>
                    <div className="flex-grow border-t border-dashed border-slate-200 mx-1.5 h-0" />
                    <div className="flex flex-col items-center gap-0.5">
                      <span className="w-3.5 h-3.5 rounded-full bg-slate-200 text-slate-600 flex items-center justify-center text-[7px]">3</span>
