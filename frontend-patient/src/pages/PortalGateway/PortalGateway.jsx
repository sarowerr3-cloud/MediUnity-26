...
import { Heart, Stethoscope, ArrowRight, ShieldCheck, Sparkles, Activity, MessageSquare, ClipboardList, Building2, Globe } from "lucide-react";
      ...
      <header className="relative z-10 w-full max-w-7xl mx-auto px-6 py-8 flex items-center justify-between" style={{ transform: 'translateZ(20px)' }}>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-slate-800/90 border border-slate-700 text-xs font-bold text-emerald-400 hover:bg-slate-700 hover:border-emerald-500 transition duration-200 cursor-pointer shadow-md font-sans"
          ...
          <div className="text-[11px] text-slate-300 font-sans flex items-center gap-1.5 bg-slate-900/80 border border-slate-700/80 px-4 py-2 rounded-full shadow-[0_0_15px_rgba(16,185,129,0.2)]">
            ...
            <span>{isBn ? "গ্লোবাল হেলথ স্ট্যান্ডার্ড" : "Global Health Standard"}</span>
          </div>
        </div>
      </header>
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center px-4 py-4" style={{ transformStyle: 'preserve-3d' }}>
        <div className="text-center max-w-2xl mb-12 flex flex-col items-center" style={{ transform: 'translateZ(50px)' }}>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/20 border border-indigo-500/40 text-indigo-200 text-[10px] font-bold uppercase tracking-widest font-sans mb-4 shadow-[0_0_20px_rgba(99,102,241,0.3)]">
            <Sparkles className="w-3.5 h-3.5" /> {isBn ? "মেডি-ইউনিটি পোর্টালে স্বাগতম" : "Welcome to MediUnity Portal"}
          </div>
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)] mb-4" style={{ transform: 'translateZ(20px)' }}>
            {isBn ? "আপনার পোর্টাল নির্বাচন করুন" : "Choose Your Gateway"}
          </h1>
          <p className="text-slate-400 text-sm sm:text-base font-sans max-w-lg mx-auto leading-relaxed drop-shadow-md">
            {isBn
              ? "নিরাপদ ডিজিটাল স্বাস্থ্য সেবা গ্রহণ করুন, সার্টিফাইড বিশেষজ্ঞ চিকিৎসকদের সাথে যুক্ত হোন এবং মেডিকেল রেকর্ড পর্যবেক্ষণ করুন।"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl px-4 perspective-[2000px]" style={{ transformStyle: 'preserve-3d' }}>
          ...
          >
            <div>
              ...
              <p className="text-slate-400 mt-3 text-sm leading-relaxed font-sans" style={{ transform: 'translateZ(10px)' }}>
                {isBn
                  ? "হেলথ ট্র্যাকার লগ দেখুন, বেনামী স্বাস্থ্য প্রশ্ন করুন, মেডিকেল রেকর্ড পরীক্ষা করুন এবং বিশেষজ্ঞদের সাথে অ্যাপয়েন্টমেন্ট বুক করুন।"
              ...
              <ul className="mt-6 space-y-4 font-sans text-xs text-slate-300 border-t border-slate-800/80 pt-6" style={{ transform: 'translateZ(15px)' }}>
                <li className="flex items-center gap-3">
                  ...
                  <span>{isBn ? "ইন্টারেক্টিভ হেলথ ট্র্যাকার" : "Interactive Health Tracker"}</span>
                </li>
                <li className="flex items-center gap-3">
                  <MessageSquare className="w-4 h-4 text-emerald-400" />
                  <span>{isBn ? "কমিউনিটি স্বাস্থ্য ফোরাম" : "Community Health Forum"}</span>
                </li>
                <li className="flex items-center gap-3">
                  <ClipboardList className="w-4 h-4 text-emerald-400" />
                  <span>{isBn ? "ডাক্তার বুকিং ও প্রেসক্রিপশন" : "Book Consultations & Locker"}</span>
                </li>
              </ul>
            </div>
            <div className="mt-8 flex items-center gap-2 text-xs font-bold font-sans uppercase tracking-wider text-emerald-400" style={{ transform: 'translateZ(25px)' }}>
              <span>{isBn ? "পেশেন্ট স্পেসে প্রবেশ করুন" : "Enter Patient Space"}</span>
          ...
          >
            <div>
              ...
              <h2 className="text-3xl font-bold text-white tracking-tight drop-shadow-md" style={{ transform: 'translateZ(20px)' }}>
                {isBn ? "ডক্টরস পোর্টাল" : "Doctors Portal"}
              </h2>
              <p className="text-slate-400 mt-3 text-sm leading-relaxed font-sans" style={{ transform: 'translateZ(10px)' }}>
                {isBn
                  ? "সিডিউল কনসালটেশন দেখুন, সময়সূচি ও স্লট নির্ধারণ করুন, রোগীর ডেটা বিশ্লেষণ করুন এবং ডিজিটাল প্রেসক্রিপশন তৈরি করুন।"
              ...
              <ul className="mt-6 space-y-4 font-sans text-xs text-slate-300 border-t border-slate-800/80 pt-6" style={{ transform: 'translateZ(15px)' }}>
                <li className="flex items-center gap-3">
                  ...
                  <span>{isBn ? "ক্লিনিক্যাল সময়সূচী ও স্লট" : "Clinical Schedule & Timeslots"}</span>
                </li>
                <li className="flex items-center gap-3">
                  <MessageSquare className="w-4 h-4 text-blue-400" />
                  <span>{isBn ? "ফোরাম ও বিশেষজ্ঞ মতামত" : "Forum Practitioner Authority"}</span>
                </li>
                <li className="flex items-center gap-3">
                  <ClipboardList className="w-4 h-4 text-blue-400" />
                  <span>{isBn ? "ই-প্রেসক্রিপশন ও অডিটিং" : "E-Prescribing & Auditing"}</span>
                </li>
              </ul>
            </div>
            <div className="mt-8 flex items-center gap-2 text-xs font-bold font-sans uppercase tracking-wider text-blue-400" style={{ transform: 'translateZ(25px)' }}>
              <span>{isBn ? "ডক্টর স্পেসে প্রবেশ করুন" : "Enter Doctor Space"}</span>
              <ArrowRight className="w-4 h-4 animate-bounce-x" />
            </div>
          </TiltCard>

          <TiltCard 
            onClick={() => window.location.href = "http://localhost:5177/partner-portal"}
          ...
          >
            <div>
              ...
              <h2 className="text-3xl font-bold text-white tracking-tight drop-shadow-md" style={{ transform: 'translateZ(20px)' }}>
                {isBn ? "পার্টনার পোর্টালস" : "Partner Portals"}
              </h2>
              <p className="text-slate-400 mt-3 text-sm leading-relaxed font-sans" style={{ transform: 'translateZ(10px)' }}>
                {isBn
                  ? "হাসপাতাল, ডায়াগনস্টিক সেন্টার এবং ফার্মেসির প্রশাসনিক নিয়ন্ত্রণ, রোস্টার, টেস্ট রিপোর্ট ও ইনভেন্টরি পরিচালনা করুন।"
              ...
              <ul className="mt-6 space-y-4 font-sans text-xs text-slate-300 border-t border-slate-800/80 pt-6" style={{ transform: 'translateZ(15px)' }}>
                <li className="flex items-center gap-3">
                  ...
                  <span>{isBn ? "হাসপাতাল রোস্টার ও বেড ট্র্যাকিং" : "Hospital Roster & Beds"}</span>
                </li>
                <li className="flex items-center gap-3">
                  <MessageSquare className="w-4 h-4 text-teal-400" />
                  <span>{isBn ? "ল্যাব রিপোর্ট ও ডায়াগনস্টিক স্লট" : "Lab Reports & Diagnostic slots"}</span>
                </li>
                <li className="flex items-center gap-3">
                  <ClipboardList className="w-4 h-4 text-teal-400" />
                  <span>{isBn ? "ফার্মেসি স্টক ও প্রেসক্রিপশন" : "Pharmacy stock & Prescriptions"}</span>
                </li>
              </ul>
            </div>
            <div className="mt-8 flex items-center gap-2 text-xs font-bold font-sans uppercase tracking-wider text-teal-400" style={{ transform: 'translateZ(25px)' }}>
              <span>{isBn ? "পার্টনার ডেস্কে প্রবেশ করুন" : "Enter Partner Desk"}</span>
              <ArrowRight className="w-4 h-4 animate-bounce-x" />
            </div>
          </TiltCard>
