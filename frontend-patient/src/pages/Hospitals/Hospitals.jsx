        ...
        {selectedDetailHospital ? (
          ...
          <div className="space-y-8 animate-fadeIn">
            ...
            <div>
              ...
              >
                <ArrowLeft size={16} /> {isBn ? "পার্টনার হাসপাতাল তালিকায় ফিরে যান" : "Back to Partner Hospitals"}
              </button>
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <div>
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="bg-emerald-500 text-[10px] text-white font-extrabold uppercase px-2 py-0.5 rounded-full border border-emerald-400/30 tracking-wider shrink-0">
                        {isBn ? "ভেরিফায়েড পার্টনার" : "Verified Partner"}
                      </span>
                    </div>
                    <a
                    ...
                    <div className="flex items-center gap-1.5 mt-2">
                      ...
                      >
                        ({selectedDetailHospital.reviewsCount || 0} {isBn ? "রিভিউ" : "reviews"})
                      </button>
                    </div>
                  </div>
                </div>
                {selectedDetailHospital.emergencyContact && (
                  <div className="text-left sm:text-right shrink-0 bg-red-50 border border-red-100 rounded-2xl p-4">
                    <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">
                      {isBn ? "জরুরি হটলাইন" : "Emergency Hotline"}
                    </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="lg:col-span-2 space-y-6">
                <h3 className="text-md font-bold text-slate-700 uppercase tracking-wider border-b pb-2">
                  {isBn ? "ক্লিনিক্যাল সার্ভিসেস ক্যাটালগ" : "Clinical Services Catalog"}
                </h3>
                {(!selectedDetailHospital.servicesCatalog || selectedDetailHospital.servicesCatalog.length === 0) ? (
                  <p className="text-slate-400 text-xs italic">
                    {isBn ? "এই হাসপাতাল দ্বারা এখনও কোনো টেস্ট বা সার্ভিস যুক্ত করা হয়নি।" : "No clinical tests added by this facility yet."}
                  </p>
                ) : (
                    ...
                    {selectedDetailHospital.servicesCatalog.filter(s => s.available).map((test) => (
                      <div key={test._id} className="py-4 flex justify-between items-center gap-4 flex-wrap">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-slate-400 mt-1">{test.description || (isBn ? "সাধারণ হাসপাতাল সেবা।" : "General hospital service.")}</p>
                        </div>
                        <div className="flex items-center gap-3 shrink-0">
                          ...
                          >
                            {isBn ? "সার্ভিস বুক করুন" : "Book Service"}
                          </button>
                        </div>
                      </div>
                    ))}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm space-y-4">
                  <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">
                    {isBn ? "আইসিইউ বেড তথ্য" : "Bed Occupancy"}
                  </h3>
          ...
          <div className="space-y-6">
            <div className="bg-white border border-emerald-100 rounded-3xl p-6 md:p-8 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <h1 className="text-2xl md:text-3xl font-extrabold text-slate-800 tracking-tight font-serif">
                  {isBn ? "পার্টনার হাসপাতাল নেটওয়ার্ক" : "Partner Hospitals"}
                </h1>
                <p className="text-slate-500 text-sm font-medium mt-2 max-w-lg">
                  {isBn
                    ? "সার্টিফাইড হাসপাতাল খুঁজুন, রিয়েল-টাইম বেড তথ্য দেখুন এবং ক্লিনিক্যাল সেবা গ্রহণ করুন।"
                    : "Discover highly-rated verified hospitals, check real-time bed availability, and book clinical services instantly."}
                </p>
              </div>
            ...
            {loading ? (
              <div className="text-center py-24 text-slate-400 font-mono text-sm tracking-wider uppercase">
                {isBn ? "হাসপাতাল নেটওয়ার্ক লোড হচ্ছে..." : "Loading hospital network..."}
              </div>
              ...
              <div className="bg-white border border-slate-200 rounded-3xl p-16 text-center shadow-sm">
                ...
                <p className="text-slate-500 font-medium">
                  {isBn ? "কোনো হাসপাতাল পাওয়া যায়নি।" : "No hospitals match your search criteria."}
                </p>
                <button onClick={() => setSearchQuery("")} className="mt-4 px-6 py-2.5 bg-emerald-50 text-emerald-700 font-bold text-xs rounded-xl hover:bg-emerald-100 transition cursor-pointer">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-1.5 mt-2">
                          ...
                          <button
                            ...
                            className="text-[10px] text-emerald-600 hover:text-emerald-800 font-bold bg-transparent border-none cursor-pointer hover:underline"
                          >
                            ({hosp.reviewsCount || 0} {isBn ? "রিভিউ" : "reviews"})
                          </button>
                        </div>
                      </div>
                    </div>
                    {hosp.emergencyContact && (
                      <div className="text-right shrink-0">
                        <p className="text-[9px] text-slate-400 font-bold uppercase tracking-wider">
                          {isBn ? "জরুরি হটলাইন" : "Emergency Hot"}
                        </p>
                  ...
                  <div className="space-y-3">
                    <h4 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                      {isBn ? "উপলব্ধ সেবা ও বেড বরাদ্দ" : "Available Services & Bed Allocations"}
                    </h4>
                          ...
                          <div key={test._id} className="py-3.5 flex justify-between items-center gap-4 flex-wrap">
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-[10px] text-slate-400 mt-0.5 line-clamp-1">
                                {test.description || (isBn ? "সাধারণ হাসপাতাল সেবা।" : "General hospital service.")}
                              </p>
                            </div>
                            <div className="flex items-center gap-3 shrink-0">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-slate-100 mt-4">
                    <span className="text-[10px] text-slate-400 font-semibold uppercase">
                      {isBn ? `আইসিইউ বেড খালি: ${hosp.bedAvailability ? (hosp.bedAvailability.total - hosp.bedAvailability.occupied) : 0}টি` : `ICU Beds: ${hosp.bedAvailability ? (hosp.bedAvailability.total - hosp.bedAvailability.occupied) : 0} Open`}
                    </span>
                    <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-md w-full border border-blue-200 shadow-2xl space-y-5">
            <div className="flex justify-between items-center border-b pb-3 shrink-0">
              <div>
                <h3 className="text-lg font-bold text-slate-800">
                  {isBn ? "ল্যাব টেস্ট / সার্ভিস বুকিং" : "Book Lab Test / Bed"}
                </h3>
            ...
            <form onSubmit={handleBookTestSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <label className="flex items-center gap-1.5 text-xs text-slate-700 cursor-pointer font-semibold">
                    ...
                    />
                    <span>{isBn ? "হাসপাতালে নগদ পরিশোধ (Cash)" : "Cash at Hospital"}</span>
                  </label>
                  <label className="flex items-center gap-1.5 text-xs text-slate-700 cursor-pointer font-semibold">
                    <input
                      type="radio"
                    ...
                    />
                    <span>{isBn ? "অনলাইন পেমেন্ট" : "Online Checkout"}</span>
                  </label>
                </div>
              </div>
              ...
              >
                {submittingTestBooking ? (isBn ? "প্রক্রিয়াকরণ হচ্ছে..." : "Processing...") : (isBn ? "বুকিং নিশ্চিত করুন" : "Confirm Booking")}
              </button>
            </form>
          </div>
        </div>
