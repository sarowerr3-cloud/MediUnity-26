...
import { Menu, X, User as UserIcon, Key, Bell, PhoneCall, AlertTriangle } from "lucide-react";
...
export default function Navbar() {
  ...
  const navItems = [
    { label: t("navbar.home", "Home"), href: "/home" },
    { label: t("navbar.services", "Services"), href: "/services" },
    { label: t("navbar.appointments", "Appointments"), href: "/appointments" },
    { label: t("navbar.community", "Community"), href: "/community" },
    { label: t("navbar.my_health", "My Health"), href: "/my-health" },
    { label: t("navbar.track", "Track"), href: "/track" },
  ];
                          ...
                          <>
                            ...
                            {unreadNotifications.map(notif => (
                              <div
                                ...
                                className={`flex gap-3 items-start p-3 hover:bg-slate-50 rounded-lg transition text-left justify-between ${notif.actionUrl ? 'cursor-pointer' : ''}`}
                              >
